...
import br.com.treinaweb.estruturasdedados.pilhas.Pilha;
...
public class Main {
	...
	private static void fazerListaDuplamenteLigada() {
		...
		listaPessoas.inserirUltimo(new Pessoa(6, "TreinaWeb 6")); //4 elemento(0..4 = 5 elementos) //�ltimo
	...
	private static void fazerListaLigada() {
		...
		listaPessoas.inserirPrimeiro(new Pessoa(5, "TreinaWeb 5")); //1 elemento //primeiro
		//listaPessoas.inserirEm(4, new Pessoa(6, "TreinaWeb 6")); //4 elemento(0..4 = 5 elementos) //�ltimo
		listaPessoas.inserirUltimo(new Pessoa(6, "TreinaWeb 6")); //4 elemento(0..4 = 5 elementos) //�ltimo
		System.out.println(listaPessoas.toString());
		Pessoa p = listaPessoas.recuperar(1);
		Pessoa pErrada = new Pessoa(100, "TreinaWeb100");
